...
import com.jisu.kotlindemoapp.class03.adapter.ChatAdapter
import com.jisu.kotlindemoapp.class03.datas.Chat
import kotlinx.android.synthetic.main.activity_class03_baseball_game.*

class Class03BaseballGameActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_class03_baseball_game)
        setupEvents()
        setValues()
    }
...
//            ?S ?B 을 판단해주는 기능 실행 => 입력한 내용을 Int로 변환해서 전달
    ...
    override fun setValues() {
        ...
        mChatAdapter = ChatAdapter(mContext, R.layout.activity_class03_baseball_chat_list_item, chatMessageList)
